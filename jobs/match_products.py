...
Matching layers (in order, first hit wins):
  ...
  2. llm_fuzzy   — OpenAI title+spec similarity (opt-in)       confidence 0.75–0.84
...
from agnaradie_pricing.matching.llm_matcher import OpenAIClient, find_best_llm_match, pre_filter_candidates
